...
public class NumpadMethod extends InputMethod {
    ...
    protected View createView() {
        ...
        mNumberButtons.put(1, controlPanel.findViewById(R.id.btn1));
        mNumberButtons.put(2, controlPanel.findViewById(R.id.btn2));
        mNumberButtons.put(3, controlPanel.findViewById(R.id.btn3));
        mNumberButtons.put(4, controlPanel.findViewById(R.id.btn4));
        mNumberButtons.put(5, controlPanel.findViewById(R.id.btn5));
        mNumberButtons.put(6, controlPanel.findViewById(R.id.btn6));
        mNumberButtons.put(7, controlPanel.findViewById(R.id.btn7));
        mNumberButtons.put(8, controlPanel.findViewById(R.id.btn8));
        mNumberButtons.put(9, controlPanel.findViewById(R.id.btn9));
