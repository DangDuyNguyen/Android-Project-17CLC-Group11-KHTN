...
import com.project.arcadedestroyer.Method.DB.ItemDB;
...
public class LobbyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        internalDb = new ItemDB(getActivity().getApplicationContext());
        store_bg_list = internalDb.getItemList(1);
        store_char_list = internalDb.getItemList(2);
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < currentUser.getBg_list().size(); i++){
                    for (int j = 0; j < store_bg_list.size(); j++){
                        if (currentUser.getBg_list().get(i).equals(String.valueOf(store_bg_list.get(j).getId())))
                ...
                char_container.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        character_img.setBackgroundResource(character.get(position).getResource());
                    }
                });
                ...
                bg_container.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        getParentFragmentManager().getFragments().get(0).getView().setBackgroundResource(background.get(position).getResource());
                        getParentFragmentManager().getFragments().get(1).getView().setBackgroundResource(background.get(position).getResource());
                        getParentFragmentManager().getFragments().get(2).getView().setBackgroundResource(background.get(position).getResource());
                    }
                });
    ...
    public void getResourceStoreItem(ArrayList<Item> character, ArrayList<Item> background){
        for(int i = 0; i < character.size(); i++){
            if(character.get(i).getId() == 6)
                character.get(i).setResource(R.drawable.char_tiger);
            else if(character.get(i).getId() == 7)
                character.get(i).setResource(R.drawable.char_buffalo);
            else if(character.get(i).getId() == 8)
                character.get(i).setResource(R.drawable.char_cow);
            else if(character.get(i).getId() == 9)
                character.get(i).setResource(R.drawable.char_bear);
            else if(character.get(i).getId() == 10)
                character.get(i).setResource(R.drawable.char_pig);
        }

        for(int i = 0; i < background.size(); i++){
            if(background.get(i).getId() == 1)
                background.get(i).setResource(R.drawable.bg2);
            else if(background.get(i).getId() == 2)
                background.get(i).setResource(R.drawable.bg3);
            else if(background.get(i).getId() == 3)
                background.get(i).setResource(R.drawable.bg4);
            else if(background.get(i).getId() == 4)
                background.get(i).setResource(R.drawable.bg5);
            else if(background.get(i).getId() == 5)
                background.get(i).setResource(R.drawable.bg6);
        }
    }
