...
public class PopUpNumpad extends Dialog {
    ...
    private View createView() {
        ...
        mNumberButtons.put(1, (Button) v.findViewById(R.id.btn1));
        mNumberButtons.put(2, (Button) v.findViewById(R.id.btn2));
        mNumberButtons.put(3, (Button) v.findViewById(R.id.btn3));
        mNumberButtons.put(4, (Button) v.findViewById(R.id.btn4));
        mNumberButtons.put(5, (Button) v.findViewById(R.id.btn5));
        mNumberButtons.put(6, (Button) v.findViewById(R.id.btn6));
        mNumberButtons.put(7, (Button) v.findViewById(R.id.btn7));
        mNumberButtons.put(8, (Button) v.findViewById(R.id.btn8));
        mNumberButtons.put(9, (Button) v.findViewById(R.id.btn9));
